...
O processo de caldeira (\textit{kettle process}) é a forma industrial em batelada da saponificação direta a quente. Conduzido em grandes tanques de aço aquecidos por vapor, ele se desenrola ao longo de vários dias por uma sequência de fervuras controladas.
